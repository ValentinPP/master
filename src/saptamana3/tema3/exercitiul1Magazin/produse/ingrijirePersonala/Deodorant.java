...
public class Deodorant extends IngrijirePersonala {

	public Deodorant(String productName, double productPrice, double applicableDiscount, boolean esteReturnabil) {
